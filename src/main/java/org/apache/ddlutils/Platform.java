...
public interface Platform {
    ...
    /**
     * Determines whether the default action for ON UPDATE is used if the specified one is not supported by the
     * platform.
     * If this is set to <code>false</code>, then an exception will be thrown if the action is not supported. By
     * default, this
    ...
    /**
     * Specifies whether the default action for ON UPDATE shall be used if the specified one is not supported by the
     * platform.
     * If this is set to <code>false</code>, then an exception will be thrown if the action is not supported. By
     * default, this
     * is set to <code>true</code> meaning that the default action would be used.
    ...
    /**
     * Determines whether the default action for ON DELETE is used if the specified one is not supported by the
     * platform.
     * If this is set to <code>false</code>, then an exception will be thrown if the action is not supported. By
     * default, this
     * is set to <code>true</code> meaning that the default action would be used.
    ...
    /**
     * Specifies whether the default action for ON DELETE shall be used if the specified one is not supported by the
     * platform.
     * If this is set to <code>false</code>, then an exception will be thrown if the action is not supported. By
     * default, this
     * is set to <code>true</code> meaning that the default action would be used.
     ...
     */
    public void alterTables(Connection connection, String catalog, String schema, String[] tableTypes,
            Database desiredDb, CreationParameters params, boolean continueOnError) throws DatabaseOperationException;
     ...
     * {@link #readModelFromDatabase(String, String, String, String[])} instead.
     */
    public String getAlterTablesSql(String catalog, String schema, String[] tableTypes, Database desiredDb)
            throws DatabaseOperationException;
     ...
     * {@link #readModelFromDatabase(Connection, String)} instead.
     */
    public String getAlterTablesSql(Connection connection, Database desiredDb, CreationParameters params)
            throws DatabaseOperationException;
    ...
    public Database readModelFromDatabase(Connection connection, String name, boolean initIndex)
            throws DatabaseOperationException;
